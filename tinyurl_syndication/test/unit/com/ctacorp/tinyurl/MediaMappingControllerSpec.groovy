...
class MediaMappingControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        ...
        then:"The model is correct"
            !model.mediaMappingInstanceList
    ...
    void "Test the create action returns the correct model"() {
        ...
        then:"The model is correctly created"
            model.mediaMappingInstance!= null
    }
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with a valid instance"
            ...
            mediaMapping = new MediaMapping(params)
    ...
    void "Test that the show action returns the correct model"() {
        ...
        then:"A model is populated containing the domain instance"
            model.mediaMappingInstance == mediaMapping
    }
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        then:"A 404 error is returned"
            response.redirectedUrl == '/mediaMapping/index'
            flash.message != null
        ...
        when:"A valid domain instance is passed to the update action"
            response.reset()
            populateValidParams(params)
            mediaMapping = new MediaMapping(params).save(flush: true)
            controller.update(mediaMapping)
    ...
    void "Test that the delete action deletes an instance if it exists"() {
        ...
        when:"A domain instance is created"
            response.reset()
            populateValidParams(params)
            def mediaMapping = new MediaMapping(params).save(flush: true)
