...
class CampaignMetricConstraintsSpec extends Specification {
    ...
    void "invalid null values shouldn't be allowed"(){
        ...
        and: "the errors should be 'nullable' for both fields"
            campaignMetricInstance.errors["day"].code == "nullable"
            campaignMetricInstance.errors["campaign"].code == "nullable"
    }
    ...
    void "oversize viewCounts should not be allowed"(){
        ...
        and: "the errors should be 'max' for both fields"
            campaignMetricInstance.errors["storefrontViewCount"].code == "max.exceeded"
            campaignMetricInstance.errors["apiViewCount"].code == "max.exceeded"
    }
    ...
    void "undersize viewCounts should not be allowed"(){
        ...
        and: "the errors should be 'max' for both fields"
            campaignMetricInstance.errors["storefrontViewCount"].code == "min.notmet"
            campaignMetricInstance.errors["apiViewCount"].code == "min.notmet"
    }
