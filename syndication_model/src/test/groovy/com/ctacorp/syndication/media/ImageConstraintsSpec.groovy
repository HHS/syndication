...
class ImageConstraintsSpec extends Specification {
    ...
    void "null fields should not be allowed"(){
        ...
        and: "the errors should be nullable"
            instance_Image.errors["height"].code     == "nullable"
            instance_Image.errors["width"].code      == "nullable"
            instance_Image.errors["imageFormat"].code     == "nullable"
            instance_Image.errors["altText"].code    == "nullable"
    }
    ...
    void "blank fields should not be allowed"(){
        ...
        and: "the errors should be blank"
            instance_Image.errors["altText"].code == "blank"
            instance_Image.errors["imageFormat"].code == "blank"
    }
    ...
    void "too-small values should not be allowed"(){
        ...
        and: "the errors should be min"
            instance_Image.errors["width"].code == "min.notmet"
            instance_Image.errors["height"].code == "min.notmet"
    }
    ...
    void "too-large values should not be allowed"(){
        ...
        and: "the errors should be max"
            instance_Image.errors["width"].code == "max.exceeded"
            instance_Image.errors["height"].code == "max.exceeded"
    }
