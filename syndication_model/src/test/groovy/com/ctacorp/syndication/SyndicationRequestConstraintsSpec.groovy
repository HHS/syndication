...
class SyndicationRequestConstraintsSpec extends Specification {
    ...
    void "null fields should not be allowed"(){
        ...
        and: "the errors should be nullable"
            instance_SyndicationRequest.errors["requestedUrl"].code == "nullable"
            instance_SyndicationRequest.errors["contactEmail"].code == "nullable"
            instance_SyndicationRequest.errors["status"].code == "nullable"
    }
    ...
    void "blank fields should not be allowed"(){
        ...
        and: "the errors should be blank"
            instance_SyndicationRequest.errors["requestedUrl"].code == "blank"
            instance_SyndicationRequest.errors["requesterNote"].code == "blank"
            instance_SyndicationRequest.errors["adminNote"].code == "blank"
            instance_SyndicationRequest.errors["contactEmail"].code == "blank"
            instance_SyndicationRequest.errors["status"].code == "blank"
    }
    ...
    void "oversized fields should not be allowed"(){
        ...
        and: "the errors should be maxSize"
            instance_SyndicationRequest.errors["requestedUrl"].code == "maxSize.exceeded"
            instance_SyndicationRequest.errors["requesterNote"].code == "maxSize.exceeded"
            instance_SyndicationRequest.errors["adminNote"].code == "maxSize.exceeded"
            instance_SyndicationRequest.errors["contactEmail"].code == "maxSize.exceeded"
            instance_SyndicationRequest.errors["status"].code == "maxSize.exceeded"
    }
