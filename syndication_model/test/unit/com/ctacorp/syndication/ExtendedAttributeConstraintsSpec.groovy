...
class ExtendedAttributeConstraintsSpec extends Specification {
    ...
    def setup() {
        mockForConstraintsTests(ExtendedAttribute)
    }
    ...
    void "null name and value fields should not be allowed"(){
        ...
        and: "the errors should be nullable"
            instance_ExtendedAttribute.errors["name"] == "nullable"
            instance_ExtendedAttribute.errors["value"] == "nullable"
    }
    ...
    void "blank name and value fields should not be allowed"(){
        ...
        and: "the errors should be blank"
            instance_ExtendedAttribute.errors["name"] == "blank"
            instance_ExtendedAttribute.errors["value"] == "blank"
    }
    ...
    void "names and values that are too long should not be allowed"(){
        ...
        and: "the errors should be maxSize"
            instance_ExtendedAttribute.errors["name"] == "maxSize"
            instance_ExtendedAttribute.errors["value"] == "maxSize"
    }
