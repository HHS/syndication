...
class InfographicConstraintsSpec extends Specification {
    ...
    def setup() {
        mockForConstraintsTests(Infographic)
    }
    ...
    void "null fields should not be allowed"(){
        ...
        and: "the errors should be nullable"
            instance_Infographic.errors["height"]     == "nullable"
            instance_Infographic.errors["width"]      == "nullable"
            instance_Infographic.errors["imageFormat"]     == "nullable"
            instance_Infographic.errors["altText"]    == "nullable"
    }
    ...
    void "blank fields should not be allowed"(){
        ...
        and: "the errors should be blank"
            instance_Infographic.errors["altText"] == "blank"
            instance_Infographic.errors["imageFormat"] == "blank"
    }
    ...
    void "too-small values should not be allowed"(){
        ...
        and: "the errors should be min"
            instance_Infographic.errors["width"] == "min"
            instance_Infographic.errors["height"] == "min"
    }
    ...
    void "too-large values should not be allowed"(){
        ...
        and: "the errors should be max"
            instance_Infographic.errors["width"] == "max"
            instance_Infographic.errors["height"] == "max"
