    ...
    <div class="footer-right">
        ...
        <div class="footer-connect-icons">
            ...
            <div class="addthis_toolbox addthis_32x32_style addthis_default_style global-footer-icons">
                ...
                <p>
                    <a href="http://www.hhs.gov/rss/" title="Visit the HHS RSS library"><asset:image src="/footer/connect-icon-rss.png" alt="Visit the HHS RSS library"/></a>
                    ...
                    <a href="http://www.hhs.gov/news/healthbeat/2014/" title="Listen to the Healthbeat Podcast"><asset:image src="/footer/connect-icon-podcast.png" alt="Listen to the Healthbeat Podcast"/></a>
    ...
    <div class="footer-left">
        ...
        <div class="global-footer-links">
            <ul class="links">
                ...
                <li><a href="http://www.hhs.gov/contactus.html">Contacting HHS</a></li>
                <li class="last"><a href="http://www.hhs.gov/accessibility.html">Accessibility</a></li>
            </ul>

            <ul class="links">
                <li><a href="http://www.hhs.gov/privacy.html">Privacy Policy</a></li>
                <li><a href="http://www.hhs.gov/budget/">Budget/AFR</a></li>
                <li><a href="http://www.hhs.gov/foia/">FOIA</a></li>
                <li><a href="http://www.hhs.gov/disclaimer.html">Disclaimers</a></li>
                <li class="last"><a href="http://www.hhs.gov/open/plain-writing/index.html">Plain Writing Act</a></li>
            </ul>
            ...
            <ul class="links">
                ...
                <li class="last"><a href="http://www.hhs.gov/recovery/">Recovery Act</a></li>
            </ul>

            <ul class="links">
                <li><a href="http://www.paymentaccuracy.gov">PaymentAccuracy.gov</a></li>
                <li><a href="http://www.hhs.gov/asa/eeo/resources/index.html">No FEAR Act</a></li>
                <li><a href="http://www.hhs.gov/environmentaljustice/">Environmental Justice</a></li>
                <li><a href="http://www.hhs.gov/surveyconfirm.html">Give Feedback</a></li>
                <li class="last"><a href="http://www.hhs.gov/answers/">FAQs</a></li>
            </ul>
