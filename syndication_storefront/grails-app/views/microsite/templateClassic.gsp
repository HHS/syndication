...
<head>
    ...
    <style>
    .microsite-classic-right-col-top.row,
    .microsite-classic-right-col-bottom.row {margin-right: 0;}
    </style>
    <!--[if IE]>
...
<div class="template container independant">
    ...
    <div class="microsite classic">
        ...
        <div class="microsite-classic-content row">
            ...
            <div class="microsite-classic-right-col col-xs-5">
            ...
            </div><!--  end microsite-classic-right-col col-xs-5 -->

        </div><!-- end microsite-content  -->
         
    </div><!-- end microsite classic -->
