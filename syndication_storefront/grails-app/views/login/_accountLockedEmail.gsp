...
<head>
    ...
    <title>Your new HHS Media Services Account</title>
    <style>
    body{
        margin:0px;
        padding:0px;
...
<div>
    ...
    <div class="banner"><div class="logo"><asset:image alt="syndication logo" absolute="true" src="smallSyndicationLogo.png"/></div><span>HHS Media Services</span></div>
    <div class="clearfix"></div>
    <div class="message_body">
        <p>You have received this email because an unlock request to your storefront account was made.</p>
        <p>
            Here is the link to unlock your account: <g:link controller="login" absolute="true" action="unlockAccount" params="[id:id,verification:verification]">Unlock Account.</g:link>
        </p>
    </div>
