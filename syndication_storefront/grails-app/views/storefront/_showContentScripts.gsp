        ...
        $(document).ready(function () {
            ...
            function updatePreview() {
                ...
                if("${mediaItemInstance}"){
                    url = "${grails.util.Holders.config.API_SERVER_URL}/api/v2/resources/media/${mediaItemInstance?.id}/embed.json?autoplay=0&" + getQueryString()
                } else if("${userMediaListInstance}"){
                    url = "${grails.util.Holders.config.API_SERVER_URL}/api/v2/resources/userMediaLists/${userMediaListInstance?.id}/embed.json?autoplay=0&" + getQueryString()
                } else if("${renderTagList}"){
                    url = "${grails.util.Holders.config.API_SERVER_URL}/api/v2/resources/tags/${id}/embed.json?autoplay=0&" + getQueryString()
                }else if("${renderSourceList}"){
                    url = "${grails.util.Holders.config.API_SERVER_URL}/api/v2/resources/sources/${id}/embed.json?autoplay=0&" + getQueryString()
                } else{
