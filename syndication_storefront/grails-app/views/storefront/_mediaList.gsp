            ...
            <div class="mediaDescription collapsedMediaDescription" id="desc_${mediaItemInstance.id}">
                ...
                <div class="mediaLinkButtons" id="medialinkbuttons_${mediaItemInstance.id}">
                    <div class="mediaPreview">
                        <a href="${grailsApplication.config.syndication.swaggerAddress + '/api/v2/resources/media/'+ mediaItemInstance.id +'/syndicate.json?ignoreHiddenMedia=1'}" onclick="addStorefrontPreviewHit(${mediaItemInstance.id})" class="syndButton popup-link">Preview</a>
                        <span>
                            <sec:ifLoggedIn>
