        ...
        <div class="modal-content">
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="false">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="builder-header-panel item active">
                        <h1 class="modal-title">Your Blog Microsite<br/><span class="modal-section-title">Step One: Header</span></h1>
                        <g:render template="../microsite/micrositeHeader"/>              
                    </div>

                    <div class="item">
                        <h1 class="modal-title">Your Blog Microsite<br/><span class="modal-section-title">Step Two: Left Column</span></h1>
                    ...
                    <div class="item">
                        <h1 class="modal-title">Your Blog Microsite<br/><span class="modal-section-title">Step Three: Right Column Top Section</span></h1>
                        <g:render template="../microsite/mediaArea" model="[area:2, mediaArea: microSite?.mediaArea2, sidePanel: true]"/>

                    </div>

                    <div class="item">
                        <h1 class="modal-title">Your Blog Microsite:<br/><span class="modal-section-title">Step Four: Right Column Bottom Section</span></h1>
                        <g:render template="../microsite/mediaArea" model="[area:3, mediaArea: microSite?.mediaArea3, sidePanel: true]"/>
                    </div>

                    <div class="item">
                        <h1 class="modal-title">Your Blog Microsite<br/><span class="modal-section-title">Step Five: Footer</span></h1>
