...
<g:set var="helpEmailAddress" value="${Holders.config.springsecurity.cmsManager.account.help.email}"/>
                ...
                <div class="panel-body">
                    ...
                    <form id='loginForm' action="${postUrl}" method="POST" autocomplete="on" role="form">
                        ...
                        <div class="form-group">
                            <input type="text" autofocus="" class="form-control" name="j_username" id="username"
