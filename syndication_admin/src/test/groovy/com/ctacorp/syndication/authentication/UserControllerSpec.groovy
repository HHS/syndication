...
class UserControllerSpec extends Specification {
    ...
    void setup() {
        ...
        def userMockService = new MockFor(AdminUserService, true)
    ...
    void "updateMyAccount action performs an update on the current users account"() {
        ...
        flash.message != null
        // ideally it redirects to /dashboard/syndDash but urlmapping again redirect this path to /dashboard/syndDash
