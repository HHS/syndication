...
class RemoteCacheServiceSpec extends Specification {
    ...
    void "test flushRemoteCacheByNameAndKey"() {
        setup:""
            ...
            def key = "key"
            String url = Holders.config.API_SERVER_URL + "/cacheAccess/flushCacheByNameAndKey?cacheName=${cacheName}&key=${key}"
    ...
    void "test flushRemoteCacheByName"() {
        setup:""
            def cacheName = "cache name"
            String url = Holders.config.API_SERVER_URL + "/cacheAccess/flushCacheByName?cacheName=${cacheName}"
    ...
    void "test flushRemoteCache"() {
        setup:""
            String url = Holders.config.API_SERVER_URL + "/cacheAccess/flushCache"
