...
class QuartzMonitorController {
    ...
    def list = {
        ...
        render view:"/quartz/list", plugin: "quartz-monitor", model: [jobs: jobsList, now: new Date(), scheduler: quartzScheduler]
    }
    ...
    def editCronTrigger = {
        ...
        render view:"/quartz/editCronTrigger", plugin: "quartz-monitor", model: [trigger: trigger]
