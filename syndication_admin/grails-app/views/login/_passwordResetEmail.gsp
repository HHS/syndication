...
<div>
    ...
    <div class="message_body">
        <h1>Your password for the Syndication Admin Panel has been reset!</h1>
        <p>Please <a href="${grailsApplication.config.grails.serverURL}">log in here</a> and change your password.</p>
